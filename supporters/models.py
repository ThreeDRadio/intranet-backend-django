...
class Supporter(models.Model):
    ...
    country = models.CharField(
        max_length=200, default="Australia", null=True, blank=True
    )
...
class SupporterNote(models.Model):
    supporter = models.ForeignKey(
        Supporter, on_delete=models.PROTECT, related_name="notes"
    )
    author = models.ForeignKey(
        User, on_delete=models.PROTECT, related_name="supporter_notes"
    )
...
class Transaction(models.Model):
    ...
    supporter = models.ForeignKey(
        Supporter, on_delete=models.PROTECT, related_name="transactions"
    )
    author = models.ForeignKey(
        User, on_delete=models.PROTECT, related_name="supporter_transactions"
    )
