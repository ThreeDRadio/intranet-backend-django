...
# Do mod_wsgi setup
ARG MOD_WSGI_VERSION=6.0.5
ADD https://github.com/GrahamDumpleton/mod_wsgi/releases/download/mod_wsgi-${MOD_WSGI_VERSION}/mod_wsgi-${MOD_WSGI_VERSION}.tar.gz /tmp/${MOD_WSGI_VERSION}.tar.gz
