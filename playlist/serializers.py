...
class ShowSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Show
        fields = ('id', 'name', 'startTime', 'endTime', 'defaultHost','active','playlists', 'topartists', 'statistics','customQuotas','femaleQuota','localQuota','australianQuota') 
...
class PlaylistSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Playlist
        fields = ('id', 'show','showname', 'host', 'date', 'notes', 'tracks', 'complete','fillin','femaleQuota','localQuota','australianQuota')
