...
class ReleaseFilter(django_filters.FilterSet):
    min_arrival = django_filters.DateFilter(
        name="arrivaldate", lookup_type="gte")
    artist = django_filters.CharFilter(name="artist", lookup_type="icontains")
    track = django_filters.CharFilter(
        name="tracks__tracktitle", lookup_type="icontains")
...
class TrackFilter(django_filters.FilterSet):
    artist = django_filters.CharFilter(
        name="album__artist", lookup_type='icontains')
    track = django_filters.CharFilter(
        name="tracktitle", lookup_type='icontains')
